...
import { MenuItemsComponent } from 'app/entities/menu-items/menu-items.component';
...
describe('Component Tests', () => {
  describe('MenuItems Management Component', () => {
    let comp: MenuItemsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MenuItemsComponent, '')
        .compileComponents();
