...
import { UserGroupsComponent } from 'app/entities/user-groups/user-groups.component';
...
describe('Component Tests', () => {
  describe('UserGroups Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserGroupsComponent, '')
        .compileComponents();
