...
export class ItemsUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    unitOfMeasurements: [null, Validators.required],
  ...
  ngOnInit() {
    ...
    this.unitOfMeasurementsService
      .query()
      .subscribe(
        (res: HttpResponse<IUnitOfMeasurements[]>) => (this.unitofmeasurements = res.body),
  ...
  updateForm(items: IItems) {
    this.editForm.patchValue({
      ...
      unitOfMeasurements: items.unitOfMeasurements,
  ...
  private createFromForm(): IItems {
    return {
      ...
      unitOfMeasurements: this.editForm.get(['unitOfMeasurements']).value,
  ...
  trackUnitOfMeasurementsById(index: number, item: IUnitOfMeasurements) {
    return item.id;
  }
