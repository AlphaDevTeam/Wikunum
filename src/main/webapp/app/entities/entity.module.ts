  ...
  imports: [
    RouterModule.forChild([
      ...
      },
      {
        ...
        loadChildren: () => import('./unit-of-measurements/unit-of-measurements.module').then(m => m.WikunumUnitOfMeasurementsModule)
      },
      {
        path: 'currency',
      ...
      {
        path: 'user-groups',
        loadChildren: () => import('./user-groups/user-groups.module').then(m => m.WikunumUserGroupsModule)
      },
      {
        path: 'menu-items',
