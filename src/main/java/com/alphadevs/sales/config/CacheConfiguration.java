...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.alphadevs.sales.domain.UnitOfMeasurements.class.getName());
            ...
            createCache(cm, com.alphadevs.sales.domain.UserPermissions.class.getName() + ".userPermissions");
            createCache(cm, com.alphadevs.sales.domain.UserPermissions.class.getName() + ".userGroups");
            createCache(cm, com.alphadevs.sales.domain.UserGroups.class.getName());
            createCache(cm, com.alphadevs.sales.domain.UserGroups.class.getName() + ".userPermissions");
            createCache(cm, com.alphadevs.sales.domain.UserGroups.class.getName() + ".users");
